...
class _MyHomePageState extends State<MyHomePage> {
 List<String> imageList = [
  ...
  List<String> Tipstitel = [
    'best tips for your diet',
    'This is the Tip Title 2',
    'This is the Tip Title 3'
  ];
  List<String> Tips = [
        ...
        children: [
          Stack(
            ...
            Padding(
                ...
                items: imageList.map((e) => ClipPath(
         ...
         child: AnimatedSmoothIndicator(
          ...
          Container(
            child: Text (Tipstitel[x] , style:GoogleFonts.lato(fontWeight: FontWeight.bold , color: Colors.black , fontSize: 25,decoration: TextDecoration.none, )),
          
          ),
          Container(
            alignment: Alignment.center,
          padding: const EdgeInsets.only(bottom: 2.0,left: 42,right: 42, top: 20),
            child: Text (Tips[x] , textAlign: TextAlign.center,style:GoogleFonts.lato(  color: Colors.grey , fontSize: 10,decoration: TextDecoration.none, )),
           ...
           // padding: const EdgeInsets.only(top:30 ,left: sizeWidth  ),
              child: Row(
                ...
                child: Text('Skip step', style: TextStyle(fontSize: 15 , color: Colors.grey),),  
...
class ClippingClass extends CustomClipper<Path> {
 ...
 var path = Path();
    ...
    var secondControlPoint =
        Offset(size.width - (size.width / 3.25), (size2*.6) + 30);
